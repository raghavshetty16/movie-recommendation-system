...
movies = pd.read_csv(r'C:\Users\Dell\Downloads\movies recamandation\movies1.csv')
ratings = pd.read_csv(r'C:\Users\Dell\Downloads\movies recamandation\ratings1.csv')
